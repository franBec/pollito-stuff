...
const randomAddress = async () => {
  ...
  while(attempts > 0){
    try {
      ...
      attempts--
      console.count('lib -> funcs-> randomAddress.js: '+error.toString())
    }
  }

  throw new Error('lib -> funcs-> randomAddress.js: Too many unsuccessful attempts. You can try again by refreshing the page')
}
